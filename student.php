...
if (isset($_POST['add'])) {
    ...
    $query = "insert into `students`(s_name,f_name,password,year,stream,reg_id,dob) values ('$s_name','$f_name','$password',$year,'$stream','$reg_id','$dob')";
        ...
        <body class="content-wrapper">
            <div style="text-align:center">
                <div class="dropdown show">
                  ...
                  <label>Course</label>
                  <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" name="stream">
                            <?php
                            $sql = "select * from class;";
                            $result = mysqli_query($dbConn, $sql);
                            if ($result) {
                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <option value="<?php $row['class_name']?>" >
                                        <?php $row['class_name'] ?>
                                    </option>
                                    <?php
                                }
                        ...
                        <div class="form-group" data-select2-id="55">
                  <label>Year</label>
                  <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" name="yearA">
