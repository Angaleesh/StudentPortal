...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card text-center col-8 d-flex align-items-center">
            ...
            <div class="card-body">
                ...
                <h5 class="card-title">Regiter ID :
                    <?php echo $stu['reg_id'] ?>
                </h5><br>
                <hr>
                ...
                <div class="button">
                    <button class="mt-3 btn btn-primary" onclick="window.print()">Print Result</button>
                </div>
            </div>
